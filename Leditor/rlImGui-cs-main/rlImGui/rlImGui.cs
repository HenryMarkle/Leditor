...
*   Modified by Henry Markle
*
*   >Modified this file<
*   >Deleted "simple_example" folder<
*   >Deleted "editor_example" folder<
*
********************************************************************************************/
...
namespace rlImGui_cs
{
    public static class rlImGui
    {
        ...
        // Added by Henry Markle (@HenryMarkle)
        ...
        public static void EndInitImGui()
        {
            ...
            {
                //*******************************************************************************************
                // Removed by Henry Markle (@HenryMarkle)
                ...
                _getClipCallback = new GetClipTextCallback(rImGuiGetClipText);
                _setClipCallback = new SetClipTextCallback(rlImGuiSetClipText);
