...
public sealed class VariedStandard(string name, int depth, (int Width, int Height) size, int[] repeat, int variations, bool random) 
    : PropDefinition(name, depth), IVaried, ILayered
{
